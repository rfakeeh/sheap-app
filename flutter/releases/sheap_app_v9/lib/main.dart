  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        // 8) SOS AlertProvider
        ChangeNotifierProxyProvider<GroupProvider, SosCounterProvider>(
          create: (_) => SosCounterProvider(),
          update: (_, groupProvider, sosCounterProvider) {
            sosCounterProvider ??= SosCounterProvider();
            sosCounterProvider.attachGroupProvider(groupProvider);
            return sosCounterProvider;
          },
        ),
      ],
      child: const MyApp(),
