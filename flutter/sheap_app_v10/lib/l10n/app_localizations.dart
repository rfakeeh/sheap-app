...
abstract class AppLocalizations {
  ...
  /// No description provided for @rejectedGroupInvitation.
  ///
  /// In en, this message translates to:
  /// **'Has rejected your invitation to join'**
  String get rejectedGroupInvitation;

  /// No description provided for @acceptedGroupInvitation.
  ///
  /// In en, this message translates to:
  /// **'Has accepted your invitation to join'**
  String get acceptedGroupInvitation;

  /// No description provided for @sentSosRequest.
  ///
  /// In en, this message translates to:
  /// **'An SOS request was sent by this member'**
  String get sentSosRequest;

  /// No description provided for @clickToHelpOrDismiss.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @doYouWantToJoin.
  ///
  /// In en, this message translates to:
  /// **'Would you like to join?'**
  String get doYouWantToJoin;
  ...
  ///
  /// In en, this message translates to:
  /// **'You are currently a member of the group.'**
  ...
  /// No description provided for @confirmSosRequest.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to send SOS alert'**
  String get confirmSosRequest;

  /// No description provided for @groupLeader.
  ///
  /// In en, this message translates to:
  /// **'group\'s leader'**
  ...
  /// No description provided for @thisGroup.
  ///
  /// In en, this message translates to:
  /// **'this group'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Failed to send SOS alert. Try again.'**
  String get sosRequestFailed;

  /// No description provided for @sosRequestAlreadySent.
  ///
  /// In en, this message translates to:
  /// **'You have already sent a pending SOS request. Please wait for their response.'**
  String get sosRequestAlreadySent;

  /// No description provided for @sosRequestSuccess.
  ///
  /// In en, this message translates to:
  /// **'SOS request sent successfully.'**
  String get sosRequestSuccess;

  /// No description provided for @sosRequestSent.
  ///
  /// In en, this message translates to:
  /// **'You have sent an SOS request'**
  String get sosRequestSent;

  /// No description provided for @cancelSosRequest.
  ///
  /// In en, this message translates to:
  /// **'Please wait for help or click to cancel SOS request.'**
  String get cancelSosRequest;

  /// No description provided for @cancelSosRequestSuccess.
  ///
  /// In en, this message translates to:
  /// **'SOS request cancelled successfully.'**
  String get cancelSosRequestSuccess;

  /// No description provided for @sosRequestCancelled.
  ///
  /// In en, this message translates to:
  /// **'SOS request was cancelled by this member'**
  String get sosRequestCancelled;

  /// No description provided for @confirmCancelSosRequest.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to cancel SOS request?'**
  String get confirmCancelSosRequest;

  /// No description provided for @confirmNavigateMemberLocation.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @toYou.
  ///
  /// In en, this message translates to:
  /// **'to you'**
  String get toYou;
  ...
  /// No description provided for @clickIfYouAreSafeOrDismiss.
  ///
  /// In en, this message translates to:
  /// **'Click if you are safe or to dismiss.'**
  String get clickIfYouAreSafeOrDismiss;

  /// No description provided for @theMemberLocation.
  ///
  /// In en, this message translates to:
  /// **'the location of member'**
  String get theMemberLocation;

  /// No description provided for @confirmYouAreSafe.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you are safe currently?'**
  String get confirmYouAreSafe;

  /// No description provided for @sosMemberSafeSuccess.
  ///
  /// In en, this message translates to:
  /// **'Thanks God you are safe currently.'**
  String get sosMemberSafeSuccess;

  /// No description provided for @isSafe.
  ///
  /// In en, this message translates to:
  /// **'This member is currently safe.'**
  String get isSafe;

  /// No description provided for @cancelSosMemberOnTheWaySuccess.
  ///
  /// In en, this message translates to:
  /// **'You cancelled your way to the SOS requester.'**
  String get cancelSosMemberOnTheWaySuccess;

  /// No description provided for @onTheWayCancelled.
  ///
  /// In en, this message translates to:
  /// **'Have cancelled the way to '**
  String get onTheWayCancelled;
  ...
  /// No description provided for @nSos.
  ///
  /// In en, this message translates to:
  /// **'SOS Now'**
  String get nSos;

  /// No description provided for @nOutsideGeofence.
  ///
  /// In en, this message translates to:
  /// **'Outside'**
  String get nOutsideGeofence;
  ...
  /// No description provided for @sosRequestNoVisibleMembers.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @enterBroadcastMessage.
  ///
  /// In en, this message translates to:
  /// **'Please enter alert message.'**
  String get enterBroadcastMessage;

  /// No description provided for @sendBroadcastMessage.
  ///
  /// In en, this message translates to:
  /// **'Send an alert to your group'**
  String get sendBroadcastMessage;
  ...
  /// No description provided for @messageTextHint.
  ///
  /// In en, this message translates to:
  /// **'It\'s crowded here. Let\'s head north.'**
  String get messageTextHint;

  /// No description provided for @makeItShort.
  ///
  /// In en, this message translates to:
  /// **'Please limit your alert to 60 characters'**
  String get makeItShort;

  /// No description provided for @broadcastSent.
  ///
  /// In en, this message translates to:
  /// **'Alert sent to group successfully.'**
